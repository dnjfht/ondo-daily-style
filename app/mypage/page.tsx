...
export default async function MyPage() {
  ...
  return <main className="shell mypage">
    <header className="topbar"><a className="brand" href="/">ondo<sup>°</sup></a><div className="header-actions"><Link href="/">오늘의 코디</Link><Link href="/profile">스타일 분석</Link></div></header>
