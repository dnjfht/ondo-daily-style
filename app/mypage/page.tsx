...
export default async function MyPage() {
  ...
  return <main className="shell mypage">
    <header className="topbar"><Link className="brand" href="/">ondo<sup>°</sup></Link><div className="header-actions"><Link href="/">오늘의 코디</Link><Link href="/profile">스타일 분석</Link></div></header>
